...
public final class WebListNavigator<T extends ListViewable> {
  ...
  // Creates a WebListNavigator of the desired ListViewable subclass
  public WebListNavigator(Iterable<T> objectList, Scanner scanner, int pageSize) {
