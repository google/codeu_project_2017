...
public class CompressionEngine{
    ...
    public static String compressMessage(Message msg){
        ...
        assert msg.equals(decompressMessage(compressed));
        return compressed;
    }
    public static Message decompressMessage(String packet){
        Gson gson = builder.create();
        Message decompressed = gson.fromJson(LZString.decompress(packet), Message.class);
        assert packet == compressMessage(decompressed);
        return decompressed;
    }
}
...
class Message{
    ...
    public boolean equals(Message m2){
        return content == m2.content && id == m2.id;
    }
}
