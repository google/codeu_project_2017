...
import codeu.chat.client.maingui.ChatMainGui;
...
final class MainGuiClientMain {

  private static final Logger.Log LOG = Logger.newLog(MainGuiClientMain.class);
  ...
  private static void runClient(Controller controller, View view) {
    ...
    final ChatMainGui chatMainGui = new ChatMainGui(controller, view);
