...
/**
 * The end-point that handles the client's request for some users. It will take a collection
 * of ids and return the corresponding users.
 */
final class GetUserByIdEndPoint extends EndPoint {

  public GetUserByIdEndPoint() {
    super(NetworkCode.GET_USERS_BY_ID_REQUEST, NetworkCode.GET_USERS_BY_ID_RESPONSE);
  }
