...
/**
 * The end-point that handles the client's request for some conversations. It will take a collection
 * of ids and return the full conversation type (compared to summaries).
 */
final class GetConversationsByIdEndPoint extends EndPoint {

  public GetConversationsByIdEndPoint() {
    super(NetworkCode.GET_CONVERSATIONS_BY_ID_REQUEST,
