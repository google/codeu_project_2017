...
public final class NetworkCode {
  ...
  public static final int
      ...
      CHECK_PASSWORD_REQUEST = 33,
      CHECK_PASSWORD_RESPONSE = 34,
      REMOVE_USER_REQUEST = 35,
      REMOVE_USER_RESPONSE = 36,
      DELETE_CONVERSATION_REQUEST = 37,
      DELETE_CONVERSATION_RESPONSE = 38;
}
