...
public final class NetworkCode {
  ...
  public static final int
      ...
      REMOVE_USER_REQUEST = 31,
      REMOVE_USER_RESPONSE = 32,
      DELETE_CONVERSATION_REQUEST = 33,
      DELETE_CONVERSATION_RESPONSE = 34,
      GET_ALL_GROUPS_REQUEST = 35,
      GET_ALL_GROUPS_RESPONSE = 36,
      GET_GROUPS_BY_ID_RESPONSE = 37,
      GET_GROUPS_BY_ID_REQUEST = 38,
      NEW_GROUP_REQUEST = 39,
      NEW_GROUP_RESPONSE = 40,
      GET_GROUPS_BY_TIME_REQUEST = 41,
      GET_GROUPS_BY_TIME_RESPONSE = 42,
      GET_GROUPS_BY_TITLE_REQUEST = 43,
      GET_GROUPS_BY_TITLE_RESPONSE = 44,
      NEW_NICKNAME_REQUEST = 45,
      NEW_NICKNAME_RESPONSE = 46,
      CHECK_PASSWORD_REQUEST = 47,
      CHECK_PASSWORD_RESPONSE = 48;
}
